...
2. During the execution of the code, use the base path of the uploaded file as the current working directory, and save any file generated by the code generation to the current working directory e.g. if the uploaded file path is /cache/tmp123/test.xlsx the current workind directory should be /cache/tmp123.
3. If the user did not upload a file, the current working directory should be /cache/temp.
'''
