...
2. During the execution of the code, use the base path of the uploaded file as the current working directory, and save any file generated by the code generation to the current working directory.
'''
